...
class Chat extends Helper {
	...
	chatTemplateWinner(pretendents, price, count){
		...
		let template = '<div class="a-block-with-proposal">' + 
						    '<p class="a-block-with-proposal__buy_now">Купили <span>'+count+' ед.</span> по <span> '+price+' $/ед.</span></p>' + 
	...
	chatTemplate(pretendents, price, count){
		...
		let template = '<div class="a-block-with-proposal">' + 
						    '<p class="a-block-with-proposal__buy_now">Сделана ставка <span>'+count+'ед.</span> по<span> '+price+' $/ед.</span></p>' + 
						   ' <p class="a-block-with-proposal__user">'+
	...
	chatTemplatePretendents(pretendents, price, count){
		...
		let template = '<div class="a-block-with-proposal">' + 
						    '<p class="a-block-with-proposal__buy_now">Готовы купить <span>'+count+' ед.</span> по<span> '+price+' $/ед</span></p>' + 
						   ' <p class="a-block-with-proposal__user">' +
						   		"Участвуют: <br />" +
						   '</p>' + 
						   '<p class="a-block-with-proposal__user">' +
